...
state.memory.authorsNote = `This is a an erotic story. It sensual and very slow. I describe how things look and feel in great detail.`
...
function pluralize(str) {
	var plural = str + "s"
	if (str.substr(str.length-1) == "s" || str.substr(str.length-2) == "sh") {
		plural = str + "es"
	}
	return plural
}
...
function add_note(str) {
	state.memory.authorsNote = state.memory.authorsNote + " " + str
}
...
I'll repeat a pokemon's species name often so that you don't forget what species they are.`)
		add_note("Everyone is naked. Nudity is normal.")
	} else {
...
I'll repeat a pokemon's species name often so that you don't forget what species they are.`)
		add_note("Pokemon can't speak. Pokemon can't talk.")
	}
}
...
scenes.set("we", {
	...
	build: function(v) {
		return load_species(v.a.name_lower, v.a.gender_word, "feral")
	}
})
...
You think for a moment and then you decide. You're not going to catch this ${a.name_lower}, you're going to fuck ${a.him}. It looks like ${a.his} ${a.g(a.dCock(),a.dPussy(),"body")} ${a.pg ? "are" : "is"} totally ${a.g("flaccid","dry","unaroused")}, in fact ${a.he}'s probably not even thinking about sex. You'll have to spend a while getting ${a.him} warmed up before ${a.hell} want to do anything fun with you.

You saunter up to the wild ${a.name_lower}, showing ${a.him} that you aren't a threat. You can't stop eyeing ${a.his} ${a.g(a.dCock(),a.dPussy(),"body")}. God, ${a.pg ? "they look" : "it looks"} delicious. You can't wait to ${a.g("have his "+a.dCock()+" inside you", "penetrate her "+a.dPussy(),"play with its body")}. Too bad ${a.his} ${a.g(a.dCock(),a.dPussy(),"body")} ${a.pg ? "are" : "is"} completely ${a.g("flaccid","dry","unaroused")} right now. You know you'll have to spend a while warming ${a.him} up before ${a.hell} be aroused enough to do anything with.

You offer ${a.him} some berries, which ${a.he} takes excitedly. Once ${a.hes} comfortable with you, you decide to begin the slow process of getting ${a.his} ${a.g(a.dCock(),a.dPussy(),"body")} ${a.g("hard","wet","turned on")}.`
...
scenes.set("md_initiation", {
	...
	build: function(v) {
		...
		add_context(`You've always wanted to join the Lustland Adventuring Guild and become an adventurer. The lead of the Lustland Adventuring Guild, ${b.name}, is a sexy ${b.gender_word} with${b.pg ? "" : " a"} ${b.g(b.dCock(),b.dPussy(),"gorgeous body")}. You have to make ${b.name} cum in order to join the guild. It is really difficult to make ${b.name} cum. You are determined to make ${b.name} cum no matter what.`)
...
"I'm a straight shooter, ${a.name}, so let me be honest with you," ${b.name} starts. "Your ${a.g(a.dCock(),a.dPussy(),"body")} ${a.pg?"have":"has"} caught my eye. I want ${a.pg?"them":"it"}, and I always get what I want."

You're not too surprised. You've heard stories about ${b.name}, so you kind of expected your initiation to be sexual in nature. What you didn't expect was for ${b.name} to be so... attractive. Everything about ${b.him} exudes ${b.g("manly","womanly","sexual")} energy.

"I'll do anything to join," you reply, seductively presenting your ${a.g(a.dCock(),a.dPussy(),"body")} to the horny guild leader.

"Alright then." ${b.name} adjusts ${b.himself} to expose his${b.m?" soft":""} ${b.g(b.dCock(),b.dPussy(),"body")}. ${b.He} gestures toward ${b.his}${b.m?" flaccid":""} ${b.g(b.dCock(),b.dPussy(),"privates")}. You gulp.`

		if (b.m) {
			str = str + ` Even flaccid, ${b.his} ${b.dCock()} ${b.pg?"are":"is"} already leaking precum. You can tell he really wants you.`
		} else if (b.f) {
			str = str + ` Her ${b.dPussy()} ${b.pg?"are":"is"} already leaking with desire. You can tell she really wants you.`
		}
		if (a.m) {
			str = str + ` The sight of ${b.pg?"them":"it"} makes your${b.m?" own":""} ${a.dCock()} engorge. Before you realize it, you're rock hard right in front of your new guild leader.`
		} else if (a.f) {
			str = str + ` This sight of ${b.pg?"them":"it"} makes your${b.f?" own":""} ${a.dPussy()} heat up. Before you realize it, you're soaking wet and dripping on the floor right in front of your new guild leader.`
		}

		str = str + `\n\n${b.name} smirks. ${b.He} knows ${b.hes} sexy. "Show me that you're worth having around," ${b.He} continues as ${b.he} positions ${b.his}${b.m?" flaccid":""} ${b.g(b.dCock(),b.dPussy(),"body")} in front of you."`
...
function getSpecies(name) {
	if (species.get(name)) {
		...
		var plural = pluralize(name_word)
...
bodySizes.set("tiny", {
	species: ["caterpie", "metapod", "weedle", "kakuna", "pidgey", "rattata", "alolan_rattata", "nidoran_f", "nidoran_m", "oddish", "paras", "parasect", "venonat", "ledyba", "spinarak", "pichu", "cleffa", "igglybuff", "togepi", "sunkern", "yanma", "phanpy", "smoochum", "elekid", "magby", "surskit", "nincada", "kricketot", "budew", "grass_burmy", "sand_burmy", "trash_burmy", "combee", "cherubi", "chingling", "bronzor", "bonsly", "mime_jr.", "happiny", "mantyke", "tepig", "oshawott", "patrat", "lillipup", "woobat", "tympole", "sewaddle", "cottonee", "petilil", "dwebble", "solosis", "vanillish", "emolga", "karrablast", "foongus", "joltik", "ferroseed", "klink", "tynamo", "litwick", "shelmet", "scatterbug", "spewpa", "flabebe", "klefki", "grubbin", "cutiefly", "solo_wishiwashi", "dewpider", "fomantis", "morelull", "bounsweet", "comfey", "wimpod", "pyukumuku", "cosmog", "cosmoem", "kartana", "meltan", "blipbug", "applin", "sizzlipede", "sinistea", "milcery", "pincurchin", "snom"],
	adj: ["tiny"]
})
bodySizes.set("small", {
...
skinTypes.set("rock", {
	species: ["geodude", "alolan_geodude", "graveler", "alolan_graveler", "golem", "alolan_golem", "onix", "forretress", "corsola", "galarian_corsola", "nosepass", "lunatone", "solrock", "baltoy", "claydol", "regirock", "sand_burmy", "sand_wormadam", "rhyperior", "roggenrola", "boldore", "gigalith", "zen_darmanitan", "sigilyph", "elgyem", "beheeyem", "druddigon", "binacle", "barbaracle", "honedge", "duoblade", "aegislash", "carbink", "diancie", "minior", "stakataka", "rolycoly", "carkol", "coalossal", "cursola", "runerigus", "stonjourner"],
	adj: ["rocks", "stone"]
})
skinTypes.set("metal", {
	species: ["magnemite", "magneton", "steelix", "skarmory", "aron", "lairon", "aggron", "beldum", "metang", "metagross", "registeel", "trash_wormadam", "trash_burmy", "chingling", "bronzor", "bronzong", "magnezone", "heat_rotom", "wash_rotom", "freeze_rotom", "fan_rotom", "mow_rotom", "escavalier", "ferroseed", "ferrothorn", "klink", "klang", "klinklang", "lampent", "chandelure", "shelmet", "golett", "golurk", "pawniard", "bisharp", "durant", "genesect", "klefki", "dhelmise", "cosmoem", "solgaleo", "celesteela", "kartana", "magearna", "meltan", "melmetal", "rookidee", "corvisquire", "corviknight", "falinks", "duraldon"],
	adj: ["metal"]
})
skinTypes.set("slime", {
...
skinTypes.set("shell", {
	species: ["shellder", "cloyster", "krabby", "kingler", "exeggcute", "kabuto", "kabutops", "togepi", "corphish", "crawdaunt", "clamperl", "clauncher", "clawitzer", "crabrawler"],
	adj: ["shell"]
})
skinTypes.set("ghost", {
	species: ["gastly", "haunter", "gengar", "misdreavus", "sableye", "duskull", "dusclops", "mismagius	", "spiritomb", "darkrai", "yamask", "galarian_yamask", "cofagrigus"],
	adj: ["ghostly essence"]
})
skinTypes.set("electricity", {
	species: ["rotom", "regieleki"],
	adj: ["electricity"],
})
skinTypes.set("plastic", {
	species: ["porygon", "voltorb", "electrode", "porygon2", "porygon_z", "missingno", "necrozma", "eternatus"],
	adj: ["plastic"]
})
skinTypes.set("silk", {
...
skinTypes.set("cloud", {
	species: ["castform", "sunny_castform", "rainy_castform", "snowy_castform", "cosmog"],
	adj: ["cloud"]
})
skinTypes.set("fabric", {
	species: ["shuppet", "banette", "drifloon", "drifblim", "dusknoir", "accelgor", "mimikyu", "blacephalon"],
	adj: ["fabric"]
})
skinTypes.set("ice", {
	species: ["glalie", "regice", "froslass", "vanillite", "vanillish", "vanilluxe", "cryogonal", "bergmite", "avalugg", "milcery", "alcremie"],
	adj: ["ice"]
})
skinTypes.set("snow", {
...
skinTypes.set("sand", {
	species: ["sandygast", "palossand"],
	adj: ["sand", "sandy"]
})
skinTypes.set("porcelain", {
	species: ["sinistea", "polteageist"],
	adj: ["porcelain"]
})
...
bodies.set("draconic_biped", {
	species: ["charizard", "dragonite", "flygon", "palkia", "druddigon", "reshiram", "zekrom", "white_kyurem", "black_kyurem", "kyurem", "goodra", "noivern", "hakamoo", "kommoo", "dracozolt", "arctozolt", "dracovish"],
	adj: ["two-legged dragon", "bipedal dragon"],
	plural: "bipdel dragons",
	arms: 2
})
bodies.set("draconic_quad", {
	species: ["salamence", "deino", "drampa", "jangmoo"],
...
bodies.set("draconic_serpent", {
	species: ["rayquaza", "origin_giratina", "runerigus", "dreepy", "drakloak", "dragapult", "eternatus"],
...
bodies.set("tortoise", {
	species: ["shuckle", "torkoal", "turtwig", "grovyle", "torterra", "turtonator"],
	plural: "tortoises"
})
bodies.set("turtle", {
	species: ["chewtle", "drednaw", "appletun"],
	plural: "turtles"
})
bodies.set("snake", {
	species: ["ekans", "onix", "steelix", "serperior", "zygarde_50", "sandaconda"],
	adj: ["snake", "serpent"],
	plural: "snakes"
})
...
bodies.set("jellyfish", {
	species: ["m_frillish", "f_frillish", "m_jellicent", "f_jellicent", "nihilego"],
	plural: "jellyfish"
})
bodies.set("seal", {
	species: ["seel", "dewgong", "popplio", "brionne", "primarina"],
	plural: "seals",
	arms: 2
})
bodies.set("clam", {
...
bodies.set("crab", {
	species: ["krabby", "kingler", "dwebble", "crustle", "crabrawler", "crabominable"],
	plural: "crabs"
})
bodies.set("seahorse", {
...
bodies.set("fish", {
	species: ["goldeen", "seaking", "magikarp", "remoraid", "barboach", "whiscash", "feebas", "relicanth", "luvdisc", "finneon", "lumineon", "alomomola", "tynamo", "stunfisk", "solo_wishiwashi", "school_wishiwashi", "bruxish", "arrokuda", "barraskewda", "arctovish"],
	plural: "fish"
})
bodies.set("starfish", {
...
bodies.set("trilobite", {
	species: ["kabuto", "anorith", "golisopod"],
	plural: "trilobites"
})
...
bodies.set("octopus", {
	species: ["octillery", "clobbopus", "grapploct"],
	plural: "octopuses",
	arms: 8
})
bodies.set("mantaray", {
...
bodies.set("anemone", {
	species: ["mareanie", "toxapex"],
	plural: "anemones"
})
bodies.set("sea_cucumber", {
	species: ["pyukumuku"],
	adj: ["sea cucumber"],
	plural: "sea cucumbers"
})
bodies.set("sea_urchin", {
	species: ["pincurchin"],
	adj: ["sea urchin"],
	plural: "sea urchins"
})
...
bodies.set("grub", {
	species: ["weedle", "larvesta", "scatterbug", "grubbin", "blipbug", "snom"],
	plural: "grubs"
})
bodies.set("cocoon", {
...
bodies.set("bug_generic", {
	species: ["paras", "parasect", "venipede", "karrablast", "escavalier", "charjabug", "dottler"],
	adj: ["insect"],
	plural: "bugs"
})
bodies.set("humanoid_bug", {
	species: ["buzzwole", "pheromosa"],
	adj: ["humanoid bug", "human-like bug"],
	plural: "humanoid bugs"
})
bodies.set("gnat", {
	species: ["venonat"],
	adj: ["insect"],
...
bodies.set("moth", {
	species: ["venomoth", "dustox", "masquerain", "mothim", "volcarona", "frosmoth"],
	plural: "moths"
})
bodies.set("worm", {
	species: ["diglett", "alolan_diglett", "dugtrio", "alolan_dugtrio", "grass_burmy", "sand_burmy", "trash_burmy", "grass_wormadam", "trash_wormadam", "sand_wormadam"],
	plural: "worms"
})
bodies.set("praying_mantis", {
	species: ["scyther", "scizor", "leavanny", "fomantis", "lurantis"],
	adj: ["praying mantis"],
...
bodies.set("ladybug_with_arms", {
	species: ["ledyba", "ledian", "orbeetle"],
	adj: ["ladybug with arms"],
	plural: "ladybugs with arms",
	arms: 4
})
bodies.set("spider", {
	species: ["spinarak", "ariados", "surskit", "joltik", "galvantula", "dewpider", "araquanid"],
	plural: "spiders"
})
bodies.set("dragonfly", {
	species: ["yanma", "vibrava", "yanmega", "vikavolt"],
	plural: "dragonflies"
})
...
bodies.set("fly", {
	species: ["cutiefly", "ribombee"],
	plural: "flies",
	arms: 4
})
bodies.set("centipede", {
	species: ["sizzlipede", "centiskorch"],
	plural: "centipedes"
})

// avian
bodies.set("bird", {
	species: ["pidgey", "pidgeotto", "pidgeot", "spearow", "fearow", "articuno", "galarian_articuno", "zapdos", "galarian_zapdos", "moltres", "galarian_moltres", "natu", "xatu", "skarmory", "ho-oh", "lugia", "shadow_lugia", "taillow", "swellow", "swablu", "latias", "latios", "starly", "cresselia", "pidove", "tranquill", "unfezant", "sigilyph", "archen", "archeops", "fletchling", "fletchinder", "yveltal", "baile_oricorio", "pompom_oricorio", "pa'u_oricorio", "sensu_oricorio", "cramorant"],
	adj: ["bird", "avian"],
	plural: "birds"
})
...
bodies.set("woodpecker", {
	species: ["pikipek", "trumbeak"],
	plural: "woodpeckers"
})
bodies.set("toucan", {
	species: ["toucannon"],
...
bodies.set("duck_bipedal", {
	species: ["psyduck", "golduck", "farfetch'd", "galarian_farfetch'd", "sirfetch'd"],
	adj: ["bipedal duck"],
...
bodies.set("owl", {
	species: ["hoothoot", "noctowl", "rowlet", "dartrix"],
	plural: "owls"
})
bodies.set("owl_humanoid", {
	species: ["decidueye"],
	adj: ["humanoid owl", "human-like owl"],
	plural: "humanoid owls",
	arms: 2
})
bodies.set("crow", {
	species: ["murkrow", "honchkrow", "rookidee", "corvisquire", "corviknight"],
	plural: "crows"
})
bodies.set("penguin", {
	species: ["piplup", "prinplup", "empoleon", "eiscue"],
	plural: "penguins"
})

// mammal
bodies.set("mouse", {
	species: ["rattata", "alolan_rattata", "raticate", "alolan_raticate", "pikachu", "raichu", "alolan_raichu", "pichu", "marill", "azurill", "plusle", "minun", "dedenne", "morpeko"],
	adj: ["mouse", "rodent"],
	plural: "mice",
	arms: 2
})
...
bodies.set("fox", {
	species: ["vulpix", "ninetails", "alolan_vulpix", "alolan_ninetales", "eevee", "vaporeon", "jolteon", "flareon", "espeon", "umbreon", "leafeon", "glaceon", "sky_shaymin", "zorua", "fennekin", "nickit", "thievul"],
	plural: "foxes"
})
...
bodies.set("bear", {
	species: ["teddiursa", "ursaring", "cubchoo", "beartic", "stufful", "bewear", "kubfu", "urshifu"],
	plural: "bears",
	arms: 2
})
bodies.set("panda", {
...
bodies.set("squirrel", {
	species: ["pachirisu", "skwovet", "greedent"],
	plural: "squirrels",
	arms: 2
})
...
bodies.set("bat", {
	species: ["zubat", "golbat", "crobat", "woobat", "swoobat", "noibat", "lunala", "naganadel"],
	plural: "bats"
})
bodies.set("cat_biped", {
	species: ["meowth", "galarian_meowth", "alolan_meowth", "snorlax", "mewtwo", "mew", "munchlax", "espurr", "m_meowstic", "f_meowstic", "perrserker"],
...
bodies.set("lion", {
	species: ["shinx", "luxio", "luxray", "therian_landorus", "litleo", "pyroar", "solgaleo"],
	plural: "lions"
})
bodies.set("tiger", {
	species: ["litten", "torracat"],
	plural: "tigers"
})
bodies.set("tiger_humanoid", {
	species: ["inceneroar", "zeraora"],
	adj: ["humanoid tiger", "human-like tiger"],
	plural: "humanoid tigers",
	arms: 2
})
bodies.set("saber_tooth_cat", {
	species: ["raikou"],
	adj: ["saber-toothed cat"],
	plural: "saber-toothed cats"
})
bodies.set("griffin", {
	species: ["type_null", "silvally"],
	plural: "griffins"
})
bodies.set("monkey", {
	species: ["mankey", "primeape", "vigoroth", "chimchar", "monferno", "infernape", "ambipom", "pansage", "simisage", "panpour", "simipour", "pansear", "simisear", "darumaka", "galarian_darumaka", "darmanitan", "galarian_darmanitan", "oranguru", "passimian", "grookey", "thwackey"],
	plural: "monkeys",
	arms: 2
})
bodies.set("gorilla", {
	species: ["slaking", "rillaboom"],
	plual: "gorillas",
	arms: 2
})
bodies.set("sloth", {
...
bodies.set("canine", {
	species: ["growlithe", "arcanine", "houndour", "houndoom", "entei", "suicune", "poochyena", "mightyena", "electrike", "manectric", "absol", "lillipup", "herdier", "stoutland", "zygarde_10", "rockruff", "yamper", "boltund", "zacian", "zamazenta"],
	adj: ["canine", "dog"],
	plural: "dogs"
})
bodies.set("wolf", {
	species: ["midday_lycanroc", "dusk_lycanroc"],
	plural: "wolves"
})
bodies.set("wolf_biped", {
	species: ["midnight_lycanroc", "zarude"],
	adj: ["bipedal wolf", "two-legged wolf"],
	plural: "bipedal wolves"
})
bodies.set("poodle", {
	species: ["furfrou"],
...
bodies.set("hedgehog", {
	species: ["land_shaymin", "chespin", "quilladin", "chesnaught", "togedemaru"],
	plural: "hedgehogs"
})
bodies.set("ferret", {
...
bodies.set("raccoon_humanoid", {
	species: ["obstagoon"],
	adj: ["humanoid raccoon", "human-like raccoon"],
	plural: "humanoid raccoons",
	arms: 2
})
bodies.set("sheep", {
	species: ["mareep", "wooloo", "dubwool"],
	plural: "sheep"
})
...
bodies.set("rabbit_humanoid", {
	species: ["azumarill", "buneary", "lopunny", "bunnelby", "diggersby", "scorbunny", "raboot", "cinderace"],
	adj: ["humanoid rabbit", "human-like rabbit"],
	plural: "humanoid rabbits"
})
bodies.set("giraffe", {
	species: ["girafarig"],
	plural: "giraffes"
...
bodies.set("elephant", {
	species: ["phanpy", "donphan", "cufant", "copperajah"],
	plural: "elephants"
})
bodies.set("deer", {
	species: ["stantler", "arceus", "spring_deerling", "summer_deerling", "autumn_deerling", "winter_deerling", "sawsbuck", "cobalion", "terrakion", "virizion", "xerneas", "calyrex"],
	adj: ["deer", "cervid"],
	plural: "deer"
})
bodies.set("camel", {
...
bodies.set("mongoose", {
	species: ["zangoose", "yungoos", "gumshoos"],
	plural: "mongeese",
	arms: 2
})
bodies.set("walrus", {
...
bodies.set("demon", {
	species: ["impidimp", "morgrem", "grimmsnarl"],
	adj: ["demon"],
	plural: "demons"
})
...
bodies.set("rock_golem", {
	species: ["graveler", "alolan_graveler", "golem", "alolan_golem", "nosepass", "baltoy", "claydol", "regirock", "probopass", "boldore", "gigalith", "elgyem", "beheeyem", "golett", "golurk", "stakataka", "stonjourner"],
	adj: ["rock golem"],
	plural: "rock golems",
	arms: 2
})
bodies.set("rock_armless", {
	species: ["roggenrola", "zen_darmanitan", "carbink", "minior", "cosmoem", "rolycoly", "carkol", "coalossal"],
	adj: ["rock golem"],
	plural: "rock golems"
})
...
// robots
bodies.set("robot", {
	species: ["magnemite", "magneton", "voltorb", "electrode", "porygon", "porygon2", "beldum", "magnezone", "porygon_z", "klink", "klang", "klinklang", "celesteela", "regidrago"],
	plural: "robots"
})
bodies.set("robot_2arms", {
	species: ["metang", "registeel", "genesect", "magearna", "melmetal", "duraldon"],
	adj: ["two-armed robot"],
	plural: "two-armed robots"
})
...
bodies.set("plant_fairy", {
	species: ["hoppip", "skiploom", "jumpluff", "whimsicott", "steenee", "tsareena", "comfey", "gossifleur", "eldegoss", "flapple"],
	adj: ["plant fairy"],
	plural: "plant faries"
})
bodies.set("seed", {
	species: ["sunkern", "seedot", "ferroseed", "ferrothorn", "bounsweet"],
	plural: "seeds"
})
bodies.set("pinecone", {
	species: ["pineco"],
...
bodies.set("coral", {
	species: ["corsola", "galarian_corsola", "cursola"],
	plural: "corals"
})
bodies.set("mushroom", {
	species: ["shroomish", "foongus", "amoongus", "morelull", "shiinotic"],
	plural: "mushrooms"
})
...
bodies.set("cloud", {
	species: ["castform", "rainy_castform", "snowy_castform", "sunny_castform", "cosmog"],
	plural: "clouds"
})
...
bodies.set("cable_monster", {
	species: ["xurkitree"],
	adj: ["cable monster"],
	plural: "cable monsters"
})
bodies.set("origami_figure", {
	species: ["kartana"],
	adj: ["origami figure"],
	plural: "origami figures"
})
...
bodies.set("disguised_creature", {
	species: ["mimikyu"],
	adj: ["disguised creature"],
	plural: "disguised creatures"
})
bodies.set("possessed_teacup", {
	species: ["sinistea"],
	adj: ["possessed teacup"],
	plural: "possessed teacups"
})
bodies.set("possessed_teapot", {
	species: ["polteageist"],
	adj: ["possessed teapot"],
	plural: "possessed teapot"
})

// specific
bodies.set("guzzlord", {
	species: ["guzzlord"],
	adj: ["huge-mouthed monster", "monster", "four-armed monster"],
	plural: "huge-mouthed four-armed monsters"
})
bodies.set("necrozma", {
	species: ["necrozma"],
	adj: ["crystalline monster"],
	plural: "crystalline monsters"
})
...
dicks.set("reptilian", {
	species: ["bulbasaur", "ivysaur", "venusaur", "charmander", "charmeleon", "aerodactyl", "chikorita", "bayleef", "meganium", "larvitar", "pupitar", "tyranitar", "tropius", "bagon", "shellgon", "salamence", "groudon", "cranidos", "rampardos", "shieldon", "bastiodon", "helioptile", "heliolisk", "tyrunt", "tyrantrum", "amaura", "aurorus", "volcanion", "salandit", "salazzle", "sobble", "drizzile", "inteleon", "dracozolt", "dracovish"],
...
dicks.set("draconic", {
	species: ["charizard", "gyarados", "alolan_exeggutor", "flygon", "altaria", "heatran", "axew", "fraxure", "haxorus", "druddigon", "deino", "reshiram", "zekrom", "kyurem", "white_kyurem", "black_kyurem", "noibat", "noivern", "yveltal", "zygarde_100", "drampa", "jangmoo", "kommoo", "hakamoo", "regidrago"],
...
dicks.set("draconic_double", {
	species: ["dragonite", "rayquaza", "zweilous", "dreepy", "drakloak", "dragapult"],
...
dicks.set("turtle", {
	species: ["squirtle", "wartortle", "blastoise", "shuckle", "torkoal", "turtwig", "grotle", "torterra", "tirtouga", "carracosta", "turtonator", "chewtle", "drednaw", "appletun"],
...
dicks.set("insect", {
	species: ["caterpie", "metapod", "butterfree", "weedle", "metapod", "paras", "parasect", "venonat", "venomoth", "pinsir", "kabuto", "kabutops", "ledyba", "ledian", "yanma", "wurmple", "silcoon", "beautifly", "cascoon", "dustox", "surskit", "masquerain", "volbeat", "illumise", "trapinch", "vibrava", "anorith", "armaldo", "kricketot", "kricketune", "grass_burmy", "sand_burmy", "trash_burmy", "grass_wormadam", "trash_wormadam", "sand_wormadam", "mothim", "combee", "vespiqueen", "skorupi", "drapion", "yanmega", "sewaddle", "swadloon", "leavanny", "venipede", "whirlipede", "scolipede", "karrablast", "escavalier", "joltik", "galvantula", "durant", "larvesta", "volcarona", "genesect", "scatterbug", "spewpa", "vivillon", "grubbin", "charjabug", "vikavolt", "cutiefly", "ribombee", "wimpod", "golisopod", "sizzlipede", "centiskorch", "snom", "frosmoth"],
	adj: ["/a <ds>"],
	pussy_adj: ["/a <ps>"],
...
dicks.set("snake", {
	species: ["ekans", "arbok", "onix", "dratini", "dragonair", "steelix", "seviper", "snivy", "servine", "serperior", "zygarde_50", "silicobra", "sandaconda"],
...
dicks.set("generic_slit", {
	species: ["poliwag", "poliwhirl", "poliwrath", "politoed", "wooper", "quagsire", "togepi", "lotad", "lombre", "ludicolo", "gulpin", "swalot", "croagunk", "toxicroak", "tympole", "palpitoad", "seismitoad", "pawniard", "bisharp", "froakie", "frogadier", "greninja", "binacle", "barbaracle", "pyukumuku", "tapu_fini", "hatenna", "hattrrem", "hatterene", "milcery", "alcremie", "pincurchin"],
...
dicks.set("rodent", {
	species: ["rattata", "alolan_rattata", "raticate", "alolan_raticate", "pikachu", "raichu", "alolan_raichu", "sandshrew", "sandslash", "alolan_sandshrew", "alolan_sandslash", "plusle", "minun", "dedenne", "morpeko"],
...
dicks.set("fox", {
	species: ["vulpix", "alolan_vulpix", "ninetales", "alolan_ninetales", "abra", "kadabra", "alakazam", "cubone", "marowak", "alolan_marowak", "eevee", "jolteon", "flareon", "espeon", "umbreon", "riolu", "lucario", "leafeon", "glaceon", "sky_shaymin", "victini", "zorua", "zoroark", "fennekin", "braixen", "delphox", "nickit", "thievul"],
...
dicks.set("feline", {
	species: ["meowth", "alolan_meowth", "galarian_meowth", "persian", "alolan_persian", "mewtwo", "mew", "raikou", "skitty", "delcatty", "shinx", "luxio", "luxray", "glameow", "purugly", "munchlax", "purrloin", "liepard", "litleo", "pyroar", "espurr", "m_meowstic", "f_meowstic", "litten", "torracat", "inceneroar", "perrserker"],
...
dicks.set("generic_knotted", {
	species: ["necrozma"],
	adj: ["knotted /a <ds>", "knotted animal /a <ds>", "knotted beast /a <ds>", "knotted beastial /a <ds>", "knotted animalistic /a <ds>"],
	pussy: "generic_sheath",
	dex_m: "A male <p>'s penis has a thick fleshy knot at the base, which expands and lodges him inside his partner when he orgasms. Once a male <ln> has knotted his partner, they'll be stuck together until his penis goes soft again. When his penis isn't in use, it's hidden in a protective fleshy sheath."
})
dicks.set("canine", {
	species: ["growlithe", "arcanine", "snubbull", "granbull", "houndour", "houndoom", "suicune", "entei", "poochyena", "mightyena", "electrike", "manectric", "absol", "lillipup", "herdier", "stoutland", "furfrou", "zygarde_10", "rockruff", "midday_lycanroc", "midnight_lycanroc", "dusk_lycanroc", "yamper", "boltund", "zacian", "zamazenta", "zarude"],
	...
	dex_m: "Male <lp> have a pink dog penis." + dicks.get("generic_knotted").dex_m
})
dicks.set("feline_knotted", {
	species: ["solgaleo", "zeraora"],
	adj: ["knotted feline /a <ds>", "knotted barbed /a <ds>", "knotted cat /a <ds>"],
	pussy: "feline",
	dex_m: dicks.get("feline").dex_m + dicks.get("generic_knotted").dex_m
})
dicks.set("tentacle", {
	species: ["tentacool", "tentacruel", "omanyte", "omastar", "octillery", "clamperl", "deoxys", "speed_deoxys", "attack_deoxys", "defense_deoxys", "west_shellos", "east_shellos", "west_gastrodon", "east_gastrodon", "darkrai", "m_frillish", "f_frillish", "m_jellicent", "f_jellicent", "inkay", "malamar", "mareanie", "toxapex", "nihilego", "xurkitree", "clobbopus", "grapploct", "eternatus"],
...
dicks.set("rock", {
	species: ["geodude", "graveler", "golem", "alolan_geodude", "alolan_graveler", "alolan_golem", "sudowoodo", "nosepass", "regirock", "probopass", "roggenrola", "boldore", "gigalith", "zen_darmanitan", "diancie", "sandygast", "palossand", "stakataka", "rolycoly", "carkol", "coalossal", "stonjourner"],
...
dicks.set("metal", {
	species: ["registeel", "dhelmise", "celesteela", "kartana", "magearna", "meltan", "melmetal", "duraldon"],
...
dicks.set("equine", {
	species: ["ponyta", "galarian_ponyta", "rapidash", "galarian_rapidash", "blitzle", "zebstrika", "cobalion", "terrakion", "virizion", "incarnate_tornadus", "therian_tornadus", "incarnate_thundurus", "therian_thundurus", "incarnate_landorus", "therian_landorus", "keldeo", "xerneas", "mudbray", "mudsdale", "glastrier", "spectrier"],
...
dicks.set("equine_knotted", {
	species: ["dialga", "type_null", "silvally"],
...
dicks.set("cervine", {
	species: ["stantler", "spring_deerling", "summer_deerling", "autumn_deerling", "winter_deerling", "sawsbuck", "calyrex"],
...
dicks.set("ursine", {
	species: ["teddiursa", "ursaring", "spinda", "cubchoo", "beartic", "pancham", "pangoro", "stufful", "bewear", "minior", "kubfu", "urshifu"],
...
dicks.set("sheep", {
	species: ["mareep", "flaaffy", "ampharos", "wooloo", "dubwool"],
	adj: ["sheep /a <ds>"],
	pussy: "generic_sheath",
...
dicks.set("electric_disembodied", {
	species: ["magnemite", "magneton", "voltorb", "electrode", "porygon", "porygon2", "magnezone", "porygon_z", "rotom", "heat_rotom", "wash_rotom", "frost_rotom", "fan_rotom", "mow_rotom", "dex_rotom", "phone_rotom", "klink", "klang", "klinklang", "regieleki"],
...
dicks.set("cetacean", {
	species: ["seel", "dewgong", "lapras", "vaporeon", "lanturn", "togetic", "mantine", "lugia", "latias", "latios", "mantyke", "togekiss", "cresselia", "popplio", "brionne", "primarina", "poipole", "naganadel", "lunala", "arctozolt", "arctovish"],
...
dicks.set("demonic", {
	species: ["shadow_lugia", "impidimp", "morgrem", "grimmsnarl"],
...
dicks.set("slime", {
	species: ["grimer", "alolan_grimer", "muk", "alolan_muk", "slugma", "magcargo", "corsola", "galarian_corsola", "goomy", "sliggoo", "goodra", "cursola"],
...
dicks.set("tongue", {
	species: ["shellder", "cloyster", "lickitung", "lickilicky", "guzzlord"],
...
dicks.set("psychic", {
	species: ["gengar", "sableye", "banette", "dusclops", "dusknoir", "uxie", "mesprit", "azelf", "trubbish", "garbodor", "runerigus"],
...
dicks.set("crustacean", {
	species: ["krabby", "kingler", "corphish", "crawdaunt", "dwebble", "crustle", "clauncher", "clawitzer", "crabrawler", "crabominable"],
	adj: ["animal /a <ds>", "animalistic /a <ds>", "beast /a <ds>", "beastial /a <ds>"],
	pussy: "generic_slit",
	dex_m: "Male <lp> have an internal penis that comes out of their body when aroused."
})
dicks.set("fish", {
	species: ["horsea", "seadra", "goldeen", "seaking", "magikarp", "chinchou", "qwilfish", "remoraid", "kingdra", "mudkip", "marshtomp", "swampert", "carvanha", "barboach", "whiscash", "feebas", "huntail", "gorebyss", "relicanth", "luvdisc", "finneon", "lumineon", "phione", "manaphy", "basculin", "alomomola", "tynamo", "eelektrik", "eelektross", "stunfisk", "galarian_stunfisk", "skrelp", "dragalge", "solo_wishiwashi", "school_wishiwashi", "bruxish", "arrokuda", "barraskewda"],
...
dicks.set("ovipositor", {
	species: ["beedrill", "spinarak", "ariados", "scyther", "scizor", "heracross", "araquanid", "dewpider", "fomantis", "lurantis", "buzzwole", "pheromosa", "blipbug", "dottler", "orbeetle"],
...
dicks.set("cloud", {
	species: ["castform", "rainy_castform", "sunny_castform", "snowy_castform", "cosmog"],
...
dicks.set("none", {
	...
	adj: ["nothing"],
	pussy_adj: ["nothing"],
	dex: "<p> have no genitals at all. <p> are completely sexless. A <ln> can't become sexually aroused. <p> have absolutely no genitals."
})
/*
dicks.set("", {
	species: [],
...
var aliases = {
	burmy: "grass_burmy",
	wormadam: "grass_wormadam",
	cherrim: "sunny_cherrim",
	shellos: "east_shellos",
	gastrodon: "east_gastrodon",
	giratina: "altered_giratina",
	shaymin: "land_shaymin",
	deerling: "spring_deerling",
	thundurus: "incarnate_thundurus",
	tornadus: "incarnate_tornadus",
	landorus: "incarnate_landorus",
	zygarde: "zygarde_50",
	hoopa: "hoopa_confined",
	oricorio: "baile_oricorio",
	wishiwashi: "solo_wishiwashi",
	lycanroc: "midday_lycanroc"
}
var genderedAliases = {
	frillish: {m: "m_frillish", f: "f_frillish"},
	jellicent: {m: "m_jellicent", f: "f_jellicent"},
	meowstic: {m: "m_meowstic", f: "f_meowstic"}
}
var simpleName = {
	alolan_rattata: "rattata",
	alolan_raticate: "raticate",
	nidoran_f: "nidoran",
	nidoran_m: "nidoran",
	...
	alolan_diglett: "diglett",
	alolan_dugtrio: "dugtrio",
	alolan_meowth: "meowth",
	galarian_meowth: "meowth",
	alolan_persian: "persian",
	alolan_geodude: "geodude",
	alolan_graveler: "graveler",
	alolan_golem: "golem",
	galarian_ponyta: "ponyta",
	galarian_rapidash: "rapidash",
	galarian_slowpoke: "slowpoke",
	galarian_slowbro: "slowbro",
	["galarian_farfetch'd"]: "farfetch'd",
	alolan_grimer: "grimer",
	alolan_muk: "muk",
	alolan_marowak: "marowak",
	galarian_weezing: "weezing",
	["galarian_mr._mime"]: "mr._mime",
	galarian_articuno: "articuno",
	galarian_zapdos: "zapdos",
	galarian_moltres: "moltres",
	galarian_slowking: "slowking",
	galarian_corsola: "corsola",
	shadow_lugia: "lugia",
	galarian_zigzagoon: "zigzagoon",
	galarian_linoone: "linoone",
	sunny_castform: "castform",
	rainy_castform: "castform",
	snowy_castform: "castform",
	attack_deoxys: "deoxys",
	defense_deoxys: "deoxys",
	speed_deoxys: "deoxys",
	grass_burmy: "burmy",
	sand_burmy: "burmy",
	trash_burmy: "burmy",
	grass_wormadam: "wormadam",
	sand_wormadam: "wormadam",
	trash_wormadam: "wormadam",
	sunny_cherrim: "cherrim",
	overcast_cherrim: "cherrim",
	east_shellos: "shellos",
	west_shellos: "shellos",
	east_gastrodon: "gastrodon",
	west_gastrodon: "gastrodon",
	heat_rotom: "rotom",
	wash_rotom: "rotom",
	frost_rotom: "rotom",
	fan_rotom: "rotom",
	...
	dex_rotom: "rotom",
	phone_rotom: "rotom",
	altered_giratina: "giratina",
	origin_giratina: "giratina",
	land_shaymin: "shaymin",
	sky_shaymin: "shaymin",
	galarian_darumaka: "darumaka",
	galarian_darmanitan: "darmanitan",
	zen_darmanitan: "darmanitan",
	galarian_zen_darmanitan: "darmanitan",
	galarian_yamask: "yamask",
	spring_deerling: "deerling",
	summer_deerling: "deerling",
	winter_deerling: "deerling",
	autumn_deerling: "deerling",
	m_frillish: "frillish",
	f_frillish: "frillish",
	m_jellicent: "jellicent",
	f_jellicent: "jellicent",
	galarian_stunfisk: "stunfisk",
	incarnate_tornadus: "tornadus",
	therian_tornadus: "tornadus",
	incarnate_thundurus: "thundurus",
	therian_thundurus: "thundurus",
	incarnate_landorus: "landorus",
	therian_landorus: "landorus",
	white_kyurem: "kyurem",
	black_kyurem: "kyurem",
	m_meowstic: "meowstic",
	f_meowstic: "meowstic",
	...
	pompom_oricorio: "oricorio",
	["pa'u_oricorio"]: "oricorio",
	sensu_oricorio: "oricorio",
	school_wishiwashi: "wishiwashi",
	solo_wishiwashi: "wishiwashi",
	midday_lycanroc: "lycanroc",
	midnight_lycanroc: "lycanroc",
	dusk_lycanroc: "lycanroc",
	jangmoo: "jangmo-o",
	hakamoo: "hakamo-o",
	kommoo: "kommo-o"
}
...
function load_species(name, gender, contextCategory) {
	...
	var name_word = data.name_word
	var name_word_plural = data.name_word_plural

	if (simpleName[name]) {
		name_word = simpleName[name]
		name_word_plural = pluralize(name_word)

		data.name_word = name_word
		data.name_word_plural = name_word_plural
	}

	// beginning
	str = `<n> is a species of pokemon.`

	// contexts
	if (contextCategory == "feral") {
		str = str + ` <n> can't speak. <n> can't talk.`
	}
	...
	str = replaceAll(str, "<n>", name_word)
	str = replaceAll(str, "<ln>", name_word.toLowerCase())
	str = replaceAll(str, "<p>", name_word_plural)
	str = replaceAll(str, "<lp>", name_word_plural.toLowerCase())
